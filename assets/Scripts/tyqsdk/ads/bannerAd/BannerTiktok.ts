...
class BannerTiktok {
    ...
    public showSystemBanner() {
        ...
        console.log("TYQSDK", 'Tiktok show systemBanner ========================')
        ...
        if (BannerController.getInstance().isLoadSystemeBanner) {
            ...
            console.log("TYQSDK", "Tiktok banner广告未加载完成");
        }
    ...
    public hideSystemBanner() {
        console.log("TYQSDK", 'Tiktok hideSystemBanner ========================')

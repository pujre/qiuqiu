...
class BannerQQ {
    ...
    public createSystemBanner(BannerId) {
        ...
        this.bannerAd.onLoad(function () {
            console.log("TYQSDK", "QQ banner加载成功");
        ...
        this.bannerAd.onError(function (err) {
            console.log("TYQSDK", "QQ banner加载失败" + JSON.stringify(err))
        })
    ...
    public showSystemBanner() {
        if (this.bannerAd) {
            console.log("TYQSDK", 'QQ show systemBanner ========================')
    ...
    public updateSytemBanner() {
        ...
        this.updateBanner =
            setInterval(() => {
                console.log("TYQSDK", 'QQ updateSystemBanner ========================')
    ...
    public hideSystemBanner() {
        if (this.bannerAd) {
            console.log("TYQSDK", 'QQ hideSystemBanner ========================')
            this.bannerAd.hide();
            this.bannerShow = false;
            this.systemBannerOnShow = false;
        } else {
            console.log("TYQSDK", "QQ 不存在系统banner ========================')");
        }
